...
app.post('/editEvent/:EventID', (req, res) => {
  ...
  const EstimatedAttendance = parseInt(req.body.EstimatedAttendance) || null;
  ...
  const FirstChoiceDate = req.body.FirstChoiceDate || null;
  ...
  const NumVolunteers = parseInt(req.body.NumVolunteers) || null;

  const VestsProduced = parseInt(req.body.VestsProduced) || null;

  const EnvelopesProduced = parseInt(req.body.EnvelopesProduced) || null;

  const PocketsProduced = parseInt(req.body.PocketsProduced) || null;

  const CollarsProduced = parseInt(req.body.CollarsProduced) || null;

  const FullyCompletedProducts = parseInt(req.body.FullyCompletedProducts) || null;
